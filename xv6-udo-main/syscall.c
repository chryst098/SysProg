...
extern int sys_setpixel0(void);
extern int sys_drawline0(void);
extern int sys_sendgraphcommands(void);
...
static int (*syscalls[])(void) = {
    ...
    [SYS_setpixel0]   sys_setpixel0,
    [SYS_drawline0]   sys_drawline0,
    [SYS_sendgraphcommands]   sys_sendgraphcommands,
};
